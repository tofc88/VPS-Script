...
view_vps_info() {
    ...
    echo -e "\e[1;34mIPv6地址:\e[0m \e[32m$(ip -6 addr show scope global | grep -v temporary | grep -v tentative | grep inet6 | awk '{print $2}' | cut -d'/' -f1 | head -n 1 | grep . || echo "未检测到全局IPv6地址")\e[0m"
